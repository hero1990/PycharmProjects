...
def main():
    ...
    for chapter_no in range(1, number_of_chapters+1):
        ...
        input_file = open(os.path.join(chapter_folder, "%d.txt" % chapter_no), "r", encoding='utf-8')
        output_file = open(os.path.join(result_folder, "%d.txt"% chapter_no), "w", encoding='utf-8')
