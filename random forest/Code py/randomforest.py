...
from sklearn.model_selection import StratifiedKFold # Add important libs

train = []
test = []         #Array Definition
path1 = r'C:\Users\nwgq2jchen1\PycharmProjects\random forest\data set\train.csv'     #Address Definition
path2 = r'C:\Users\nwgq2jchen1\PycharmProjects\random forest\data set\test.csv'
...
crossvalidation = StratifiedKFold(n_splits=9)
...
path3 = r'C:\Users\nwgq2jchen1\PycharmProjects\random forest\data set\result.csv'
