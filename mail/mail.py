...
def send_email(sender, password, receiver, msg):
    ...
    try:
        ...
        server = smtplib.SMTP("smtp.163.com", 25)  # 发件人邮箱中的SMTP服务器
        server.ehlo()
        #登录你的账号
...
def main():
    ...
    my_sql = sql = "SELECT storerkey from storer ;"
    # 生成数据
    ...
    # 文件路径
    file_path = 'C:/work/report/' + my_file_name
    # 生成excel
    ...
    my_sender = 'hero403194754@163.com'
    my_password = 'hero19901001'
    my_receiver = ['jack-sj.chen@dbschenker.com']   #接收人邮箱列表
    # 发送邮件
